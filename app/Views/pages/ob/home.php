        ...
        <div class="card border-0 shadow rounded-0">
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between">
                    <h5 class="card-title lead">OB Request List</h5>

                    <a href="<?= base_url('ob/create') ?>" class="btn btn-primary rounded-0 col-12 col-lg-auto">
                        <span>
                ...
                <table id="ob" class="table table-striped align-middle w-100"></table>
...
<?= $this->include('App\Views\scripts\ob\datatable') ?>
