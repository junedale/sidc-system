    ...
    <div class="card border-0 shadow rounded-0">
        <div class="card-body">
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                <h5 class="card-title lead">Stock Request List</h5>

                <?php if(in_group('tsr') && !has_permission('approval.stock.initial')): ?>

                    <a href="<?= base_url('stock/create') ?>" class="btn btn-primary rounded-0 col-12 col-lg-auto">
                        <span>
            ...
            <table id="stock" class="table table-striped align-middle w-100">
...
<?= $this->include('App\Views\scripts\stock\datatable') ?>
