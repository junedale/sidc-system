        ...
        <div class="card border-0 shadow rounded-0">
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                    <h5 class="card-title lead">Overtime Request List</h5>
                    <a href="<?= base_url('overtime/create') ?>" class="btn btn-primary rounded-0 col-12 col-lg-auto">
                        <span>
                ...
                <table id="overtime" class="table table-striped align-middle w-100">
...
<?= $this->include('App\Views\scripts\overtime\datatable') ?>
